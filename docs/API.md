...
You can find a current copy of the OME API documentation [here](https://dl.dell.com/content/manual63564712-dell-emc-openmanage-enterprise-3-8-3-restful-api-guide.pdf?language=en-us&ps=true).
