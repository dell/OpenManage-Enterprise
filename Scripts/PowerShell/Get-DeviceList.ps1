...
<#
 ...
 .EXAMPLE
   ...
   Get-DeviceList -IPAddress "10.xx.xx.xx" -Fileextension json -UserName admin
   Get-DeviceList -IpAddress 100.96.20.132 -Fileextension CSV -UserName admin -Outfilepath C:\Users\Desktop\test.csv
   Get-DeviceList -IpAddress 100.96.20.132 -Fileextension json -UserName admin -Outfilepath C:\Users\Desktop\test.json
...
#Get-DeviceList -IpAddress 100.96.20.132 -Fileextension txt -UserName admin -Outfilepath C:\Users\priya_raju1\Desktop\OME\test.csv
   currently being managed by that instance. For authentication X-Auth
   is used over Basic Authentication
